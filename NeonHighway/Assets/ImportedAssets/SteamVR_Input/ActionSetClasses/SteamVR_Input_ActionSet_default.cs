...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean UpperButtonClick
        {
            get
            {
                return SteamVR_Actions.default_UpperButtonClick;
            }
        }
        
        public virtual SteamVR_Action_Boolean LowerButtonClick
        {
            get
            {
                return SteamVR_Actions.default_LowerButtonClick;
            }
        }
