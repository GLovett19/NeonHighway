...
//	[HideInInspector]
	...
	[Header("MyEdits")]
	public bool magRelease; // if there is a quick mag release on this gun
	bool magReleaseClick;// if the mag release button has been clicked
	public SteamVR_Action_Boolean LowerButtonClick = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("LowerButtonClick"); //input
	public bool holdOpen; // if this gun has a hold open feature 

	public bool holdOpenRelease;// if this gun has a quick hold open release
	 ...
	 * ADD
	 *	Mag Release button
	 *		Bool for enabled/disabled  - Complete
	 *		input check on face button - Complete 
	 *		
	 *	Bolt/Slide hold open on empty
	 *		Bool for enabled/ disabled - Complete
	 *		
	 *	Bolt/Slide release
	 *		Bool for enabled/Disabled - Complete
	 *		input check on face button
	 *		
	 */
    void Start()
    {
